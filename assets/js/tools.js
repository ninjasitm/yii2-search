...
function Tools ()
{
	 ...
	 */
	this.initSubmitSelect = function (container) {
	 ...
	 */
	this.initVisibility = function (container) {
		var container = (container == undefined) ? 'body' : container;
	 ...
	 */
	this.initRemoveParent = function (container) {
	 ...
	 */
	this.initDisableParent = function (container) {
		var container = (container == undefined) ? '' : container;
		//enable hide/unhide functionality
		$(container).find("[role='removeParent']").map(function(e) {
			$(this).on('click', function (e) {
	 ...
	 */
	this.initAutocompleteSelect = function (container) {
		var container = (container == undefined) ? 'body' : container;
	 ...
	 */
	this.initOffCanvasMenu = function (container) {
		var container = (container == undefined) ? '' : container;
